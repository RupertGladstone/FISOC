...
ROMS_temperature_l0 = ROMS_grp.variables["temp"]
#print ROMS_temperature_l0.shape
ROMS_temperature_lx = ROMS_temperature_l0[timestep,10,:,:]
ROMS_temperature_l0 = ROMS_temperature_l0[timestep,0,:,:]
...
plt.subplot(1, 6, 4)
plt.imshow(ROMS_temperature_lx,vmin=-2.3,vmax=-1.8)
plt.colorbar()
plt.axis('off')  
