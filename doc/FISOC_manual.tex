...
*** need a proper description of the relevant directives for ROMS compilation: ***
FISOC
FISOC\_DDDT
FISOC\_DSDT
FISOC\_DRAFT
...
The calculation of pressure at the ice-ocean interface no longer estimates the weight of the ice column based on the assumption of floatation, but rather uses the actual ice thickness to estimate pressure.  The value for ice density defined in iceshelf_mod.h is used.
